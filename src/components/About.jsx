...
function About() {
    return (
      <>
        <div className="grid grid-cols-1 md:grid-cols-2 mx-4 md:mx-14 p-5 my-10 md:border md:border-black border border-white text-white">
          <div className="border-white px-5 py-15 md:py-20">
                ...
                ><span className="text-2xl">Hey,I'm</span><br/>
                    <span className="text-2xl">BHARATH KUMAR KARE</span>
                </motion.h1>
                <motion.h1
                initial={{opacity:0}}
                animate={{opacity:1}}
